...
def blur(event):
    ...
    for m in range(0, v1.get()+1):
            ...
            canvas2.create_image(300, 200, image=img1)
            canvas2.image=img1
...
blurr = Label(root, text="Blur:", font=("italic 17 bold"), width=9, anchor='e')
...
bright = Label(root, text="Brightness:", font=("italic 17"))
...
contrast = Label(root, text="Contrast:", font=("italic 17"))
...
rotate = Label(root, text="Rotate:", font=("ariel 17"))
rotate.place(x=370, y=8)
values = [0, 45, 90, 135, 180, 225, 270, 315, 360]
rotate_combo = ttk.Combobox(root, values=values, font=('italic 10'))
rotate_combo.place(x=460, y=15)
rotate_combo.bind("<<ComboboxSelected>>", rotate_image)
flip = Label(root, text="Flip:", font=("ariel 17"))
flip.place(x=400, y=50)
values1 = ["FLIP LEFT TO RIGHT", "FLIP TOP TO BOTTOM"]
flip_combo = ttk.Combobox(root, values=values1, font=('italic 10'))
flip_combo.place(x=460, y=57)
flip_combo.bind("<<ComboboxSelected>>", flip_image)
border = Label(root, text="Add border:", font=("italic 17"))
border.place(x=320, y=92)
values2 = [i for i in range(10, 90, 5)]
border_combo = ttk.Combobox(root, values=values2, font=("italic 10"))
...
# create buttons
btn1 = Button(root, text="Upload Image", bg='white', fg='black', font=('italic 15'), relief=GROOVE, command=selected)
btn1.place(x=100, y=595)
btn2 = Button(root, text="Save as", width=12, bg='white', fg='black', font=('italic 15'), relief=GROOVE, command=save)
btn2.place(x=280, y=595)
btn3 = Button(root, text="Exit window", width=12, bg='white', fg='black', font=('italic 15'), relief=GROOVE, command=root.destroy)
